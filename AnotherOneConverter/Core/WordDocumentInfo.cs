...
namespace AnotherOneConverter.Core {
    public class WordDocumentInfo : DocumentInfo {
        private static readonly log4net.ILog Log = log4net.LogManager.GetLogger(typeof(WordDocumentInfo));

        public WordDocumentInfo(string filePath) : base(filePath) { }

        public override Bitmap Icon {
            get {
                return Resources.File_Word;
            }
        }
