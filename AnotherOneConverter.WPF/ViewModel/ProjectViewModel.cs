...
namespace AnotherOneConverter.WPF.ViewModel
{
    public class ProjectViewModel : ViewModelBase, IDisposable
    {
        ...
        public ProjectViewModel(IDocumentFactory documentFactory, INotificationService notificationService)
        {
        ...
        [JsonIgnore]
        public RelayCommand ExportToOne => _exportToOne ?? (_exportToOne = new RelayCommand(OnExportToOne, () => IsLoading == false));
